...
const board_t ArdwiinoLookup::boards[20] = {
    ...
    {"a-micro", "a-micro", "Arduino Micro in Bootloader Mode", 57600, {0x0037}, "avr109", "atmega32u4", 16000000, "/images/ArduinoMicro.svg", false, true},
    ...
    {"micro", "micro", "Arduino Pro Micro in Bootloader Mode", 57600, {0x9205, 0x9207}, "avr109", "atmega32u4", 8000000, "/images/ArduinoLeonardo.svg", false, true},
    {"micro", "micro", "Arduino Pro Micro in Bootloader Mode", 57600, {0x9203}, "avr109", "atmega32u4", 16000000, "/images/ArduinoLeonardo.svg", false, true},
