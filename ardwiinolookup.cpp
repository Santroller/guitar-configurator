...
const board_t ArdwiinoLookup::boards[20] = {
    ...
    {"leonardo", "leonardo", "Arduino Micro / Pro Micro / Leonardo in DFU Mode", 57600, {0x0036}, "avr109", "atmega32u4", 16000000, "/images/ArduinoLeonardo.svg", false, true},
    {"micro", "micro", "Arduino Pro Micro in DFU Mode", 57600, {0x9205, 0x9207}, "avr109", "atmega32u4", 8000000, "/images/ArduinoLeonardo.svg", false, true},
    ...
    {"pico", "pico", "Raspberry PI Pico (Picoboot)", 0, {0x0003}, "pico", "rp2040", 0, "/images/Pico.svg", false, true},
