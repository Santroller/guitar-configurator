...
const board_t ArdwiinoLookup::boards[4] = {
    {"uno-usb","Arduino Uno",57600,{},"dfu","atmega16u2",16000000,"Arduino-usbserial-atmega16u2-Uno-Rev3","images/uno.png"},
    {"uno-main","Arduino Uno",115200,{0x0043, 0x7523, 0x0001, 0xea60, 0x0243},"arduino","atmega328p",16000000,"","images/uno.png"},
...
bool ArdwiinoLookup::hasDFUVariant(const board_t board) {
    return board.hexFile.contains("-main") || board.hexFile.contains("-usb");
}
