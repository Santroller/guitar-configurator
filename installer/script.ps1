$ver=Invoke-RestMethod -Uri 'https://api.github.com/repos/sanjay900/guitar-configurator/tags' | % { $_.name}  | sort -Descending {[version] $_.Substring(1)} | Select-Object -first 1
